...
void EditAkun() {
    ...
    while (1) {
        ...
        if (step == 0) { // Pilih jabatan
            ...
            } else if (key == 8 && strlen(username) > 0) { // Backspace
            ...
            } else if (key == 8 && strlen(sandi) > 0) { // Backspace
            ...
            if (konfirmasiIndex == 1) { // Konfirmasi
